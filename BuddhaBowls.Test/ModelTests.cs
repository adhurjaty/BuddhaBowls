    ...
    public class ModelTests
    {
        ...
        public void ConstructPurchaseOrderTest()
        {
            ...
            try
            {
                ...
                List<InventoryItem> poItems = po.ItemList;
        ...
        public void ReceiveOrderTest()
        {
            ...
            {
                po.Receive();
                List<InventoryItem> receivedItems = po.ItemList;
        ...
        public void ReopenOrderTest()
        {
            ...
            try
            {
                po.Receive();
                po.ReOpen();
                List<InventoryItem> reopened = po.ItemList;
        ...
        public void GetBatchItemCostTest()
        {
            ...
            Assert.AreEqual((float)4.01, Math.Round(cost, 2));
        }
        ...
        public void GetComplexRecipeCostTest()
        {
            ...
            List<RecipeItem> desired = CreateComplexRecipe();
        ...
        private List<RecipeItem> CreateComplexRecipe()
        {
            List<IItem> baseItems = new List<IItem>()
            {
            ...
            return baseItems.Select(x => new RecipeItem()
            {
                Name = x.Name,
                InventoryItemId = x.Id,
                Quantity = 5,
